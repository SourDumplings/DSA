...
namespace CZ
{
    ...
    Expression::Expression(const std::string &exp_, const char delimiter_):
    Expression(exp_.c_str(), delimiter_) {}

    Expression::Expression(const CZString &exp_, const char delimiter_):
    Expression(exp_.c_str(), delimiter_) {}

    Expression::~Expression() { if (_exp) delete [] _exp; }
